package br.dev.bs.shortenerapi.config.jwt;
...
@Service
public class JwtValideteService {

    private final String SECRET_KEY;

    private final String JWT_EXPIRATION_TIME;

    public JwtValideteService(@Value("${application.jwt.secret.key}") final String secretKey, @Value("${JWT_EXPIRATION_TIME}") final String jwtExpirationTime) {
